    ...
    <div class="col-6 col-md-4">
        ...
        <div class="list-group text-white bg-dark">
            {#each data.discordServers as server}
                <a href={server.url} class="list-group-item list-group-item-action bg-dark text-white" rel="noopener nofollow" target="_blank" title="Visit discord">
                    <img src={server.icon} class="class-icon"> {server.class}
                </a>
            {/each}
        </div>
    </div>
    ...
    <div class="col-6 col-md-4">
        ...
        <div class="list-group text-white bg-dark">
            {#each data.generalWebsites as site}
                <a href={site.url} class="list-group-item list-group-item-action bg-dark text-white" rel="noopener" target="_blank" title="Visit website">
                    {#if site.image}
